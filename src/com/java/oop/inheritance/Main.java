...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        RegularCustomer regularCustomer1 = new RegularCustomer("2","Laxman Reddy","laxmanreddy4728.@gmailcom","32452323",67567,35,500);
        regularCustomer1.signup();
        regularCustomer1.login();
        regularCustomer1.displayCustomerDetails();

        PremiumCustomer premiumCustomer = new PremiumCustomer("3","Laxman Reddy1","laxmanreddy47282@gmail.com","54645345",true,500);
